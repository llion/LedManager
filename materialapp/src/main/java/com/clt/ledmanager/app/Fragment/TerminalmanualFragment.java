 ...
 */
public class TerminalmanualFragment extends Fragment {
    private static final String KEY_TITLE = "title";

    public TerminalmanualFragment() {
        // Required empty public constructor

    }

    public static TerminalmanualFragment newInstance(String title) {
        TerminalmanualFragment f = new TerminalmanualFragment();

        ...
        result = new DrawerBuilder()
                ...
                .withOnDrawerNavigationListener(new Drawer.OnDrawerNavigationListener() {
                    ...
                    public boolean onNavigationClickListener(View clickedView) {
                        ...
                        AdvancedMainActivity.this.finish();
...
//                                    getSupportActionBar().setTitle(R.string.drawer_item_home);
                            ...
                            if (drawerItem instanceof Nameable) {
                                Toast.makeText(AdvancedMainActivity.this, ((Nameable) drawerItem).getName().getText(AdvancedMainActivity.this), Toast.LENGTH_SHORT).show();
                            }

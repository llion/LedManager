...
import com.clt.ledmanager.ui.ReceiverShowViewSimpleType;
...
public class ConnectRelationActivity extends BaseObserverFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.connect_relation_simple, container, false);
    ...
    private void initView(View view) {
        try {
            ...
            etRow = (EditText) view.findViewById(R.id.et_send_row);
            etRow.setText(String.valueOf(this.row));
            etColumn = (EditText) view.findViewById(R.id.et_send_column);
            ...
            spinnerSender = (CustomerSpinner) view.findViewById(R.id.spinner_send_card);
            ...
            spinnerPort = (CustomerSpinner) view.findViewById(R.id.spinner_port_number);
            spinnerPort.initView(R.array.ports);
            spinnerPort.setSelection(0, true);

            spinnerLinkDirect = (CustomerSpinner2) view.findViewById(R.id.spinner_link_path);
            ...
            // view.findViewById(R.id.spinner_smart_link);
            // spinnerSmartLink.initView(R.array.smart_link);
            // spinnerSmartLink.setSelection(0, true);// 是否

            btnAdanved = (Button) view.findViewById(R.id.btn_advanced);
            btnSend = (Button) view.findViewById(R.id.btn_send);
            btnSolid = (Button) view.findViewById(R.id.btn_save_to_rcv);
            btnSelectAll = (Button) view.findViewById(R.id.btn_select_all);
            btnReset = (Button) view.findViewById(R.id.btn_reset);
            btnEmptyCard = (Button) view.findViewById(R.id.btn_empty_card);

            rsvShowView = (ReceiverShowViewSimpleType) view.findViewById(R.id.rs_showview);

            // final LinearLayout llShowView=(LinearLayout)
            // view.findViewById(R.id.ll_showview);
            // Button btnGoDown=(Button) view.findViewById(R.id.btn_go_down);
            ...
            // }
            // });
            // Button btnGoRight=(Button) view.findViewById(R.id.btn_go_right);
            // spinner = (CustomerSpinner)
            // view.findViewById(R.id.spinner_receiver_port);
        ...
        try {
            switch (msg.what) {
                ...
                case NetMessageType.setConnectionToSenderCardAnswer: {
                    ...
                    if (nm.getErrorCode() == 0) {
                        Toast.makeText(getActivity(), getResString(R.string.setting_fail), Toast.LENGTH_SHORT)
                                .show();
                    } else {
                        Toast.makeText(getActivity(), getResString(R.string.setting_success), Toast.LENGTH_SHORT)
                                .show();
                    }
                }
                break;

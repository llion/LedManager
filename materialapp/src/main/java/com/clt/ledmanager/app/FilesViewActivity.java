...
import com.clt.ledmanager.adapter.FileListAdapter.OnSelectFilesListener;
 ...
 * 
 */
public class FilesViewActivity extends com.clt.ledmanager.activity.BaseActivity implements OnSelectFilesListener
{
	//支持的图片格式

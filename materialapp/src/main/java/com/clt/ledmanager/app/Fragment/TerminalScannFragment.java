 ...
 */
public class TerminalScannFragment extends Fragment {
    private static final String KEY_TITLE = "title";

    public TerminalScannFragment() {
        // Required empty public constructor

    }

    public static TerminalScannFragment newInstance(String title) {
        TerminalScannFragment f = new TerminalScannFragment();
